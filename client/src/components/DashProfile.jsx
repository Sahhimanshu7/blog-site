  ...
  return (
    <div className='p-3 w-full max-w-lg mx-auto'>
      ...
      <form className='flex flex-col space-y-4 md:min-w-[40vw]'>
        <TextInput type="text" id = "username" placholder='username' defaultValue={currentUser.username} />
        <TextInput type="text" id = "email" placholder='email' defaultValue={currentUser.email} />
